  ...
  _createClass(Fuse, [{
    ...
    value: function _analyze(_ref2) {
      ...
      var key = _ref2.key,
          ...
          record = _ref2.record,
          index = _ref2.index,
          _ref2$tokenSearchers = _ref2.tokenSearchers,
      ...
      if (List.isList(value)) {
        return value.reduce(function (accumulation, item, i) {
          return _this3._analyze({
            key: key,
            arrayIndex: i,
            value: item,
            record: record,
    ...
    key: '_analyzeString',
    value: function _analyzeString(_ref3) {
      var _this4 = this;
      ...
      var key = _ref3.key,
          ...
          record = _ref3.record,
          index = _ref3.index,
          _ref3$tokenSearchers = _ref3.tokenSearchers,
